function [] = CompetitionLatticeSearch_2Row(DNA,n_RAD51,n_A,n_D)
        n_RPA = n_A+n_D;    %total length of RPA (easier than using another input)
        ...
        Bound_Counts = [x_Bound_RAD51_M,x_Bound_RAD51_D,x_Bound_RPA_A,x_Bound_RPA_D];  %counts of how many bound proteins of each type (and are free to do the corresponding reaction)
                    ...
                    % 4 - RPA-D
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        Counts = [Available_Counts, Bound_Counts];  %All the counted values (number of available positions on the lattice, number of bound proteins of each type)
end