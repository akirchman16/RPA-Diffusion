...
minIterations = 100;
AvgIterations = 10;  %number of times to run each DiffusionRate value where averages will then be calculated
...
DiffusionRate_Values = [0,logspace(1,10,10)];    %RPA Diffusion Rate constant values (events/time interval)
